...
let initialState2 = {
                    ...
                    searchMode:false,
                    searchResults:[],
                    selectProducts:[{'index':'0','path':'../images/apple.jpg','name':'apple','price':'4.99',"quantity":0,"type":"fruit"},{'index':'1','path':'../images/pear.jpg','name':'pear','price':'3.59',"quantity":0,"type":"fruit"},{'index':'2','path':'../images/watermelen.jpg','name':'watermelen','price':'6.99',"quantity":0,"type":"fruit"},{'index':'3','path':'../images/banana.jpg','name':'banana','price':'2.99',"quantity":0,"type":"fruit"},{'index':'4','path':'../images/tomato.jpg','name':'tomato','price':'3.99',"quantity":0,"type":"vegetible"},{'index':'5','path':'../images/celery.jpg','name':'celery','price':'4.29',"quantity":0,"type":"vegetible"},{'index':'6','path':'../images/onion.jpg','name':'onion','price':'1.99',"quantity":0,"type":"vegetible"},{'index':'7','path':'../images/carrot.jpg','name':'carrot','price':'2.99',"quantity":0,"type":"vegetible"}],
                    products:[{'index':'0','path':'../images/apple.jpg','name':'apple','price':'4.99',"quantity":10,"type":"fruit"},{'index':'1','path':'../images/pear.jpg','name':'pear','price':'3.59',"quantity":8,"type":"fruit"},{'index':'2','path':'../images/watermelen.jpg','name':'watermelen','price':'6.99',"quantity":15,"type":"fruit"},{'index':'3','path':'../images/banana.jpg','name':'banana','price':'2.99',"quantity":5,"type":"fruit"},{'index':'4','path':'../images/tomato.jpg','name':'tomato','price':'3.99',"quantity":18,"type":"vegetible"},{'index':'5','path':'../images/celery.jpg','name':'celery','price':'4.29',"quantity":12,"type":"vegetible"},{'index':'6','path':'../images/onion.jpg','name':'onion','price':'1.99',"quantity":25,"type":"vegetible"},{'index':'7','path':'../images/carrot.jpg','name':'carrot','price':'2.99',"quantity":19,"type":"vegetible"}]}
//clickAddItem
function addOrRemoveItemReducer(state=initialState2,action){
    ...
    switch(action.type){
        ...
        case 'REMOVE_ITEMS':
            const originalQty = [10,8,15,5,18,12,25,19];
